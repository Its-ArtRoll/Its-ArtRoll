...
<h3>📚 About Me</h3>
<img align="right" src="https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExejAwNTY2bzBlM2t3ZzhlOWJnMTA1MG1nMTlrcW80NmY4N3p2c2NlMiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/GYtblmdLnemlO/giphy.gif" alt="fatkhurrhn profile side image" width="270" />
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li>Scalable web and mobile applications with clean UI and solid backend systems</li>
        <li>Cross-platform apps using Flutter for fast and consistent user experiences</li>
        <li>Using AI to enhance features, automate tasks, and explore smarter solutions</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <strong>🔭 Current Focus</strong>
      <ul>
        <li>Full-stack development (frontend, backend, and API integration)</li>
        <li>Building mini projects with Flutter to strengthen mobile development skills</li>
        <li>Exploring AI tools to speed up development and learn new concepts</li>
      </ul>
    </td>
  </tr>
</table>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Chat_Bot-4A90E2?style=for-the-badge&logo=chatbot&logoColor=white" alt="Chat Bot" />
...
<table align="center">
  <tr>
    <td width="49%" valign="top">
      <img width="100%" src="https://ghstats.dev/api/card?username=fatkhurrhn&bg=0D1117&text=A8B3A9&title_color=8DBA8E&icon_color=D6A85E&hide_border=true&show_icons=true&show_ring=false&hide=grade&custom_title=Forest%20Log" alt="GitHub forest log" />
    </td>
    <td width="2%"></td>
    <td width="49%" valign="top">
      <img width="100%" src="https://ghstats.dev/api/langs?username=kamachiii&layout=bar&max_langs=6&bg=0D1117&text=A8B3A9&title_color=8DBA8E&icon_color=D6A85E&hide_border=true&custom_title=Language%20Garden" alt="Language garden" />
      <br/>
      <img width="100%" src="https://streak-stats.demolab.com?user=fatkhurrhn&theme=dark&hide_border=true&background=0D1117&ring=8DBA8E&fire=D6A85E&currStreakLabel=8DBA8E&sideNums=D6A85E&currStreakNum=D6A85E&dates=A8B3A9&sideLabels=A8B3A9&card_height=250" alt="GitHub streak stats" />
    </td>
  </tr>
</table>

<img src="./img/footer.jpg" alt="fatkhurrhn footer" width="100%" />
